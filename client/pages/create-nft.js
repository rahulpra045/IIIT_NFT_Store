...
export default function createNFT(){
    ...
    async function imageUpload(e) {
        ...
        try{
            ...
            const ImageURL = `https://gateway.pinata.cloud/ipfs/${resFile.data.IpfsHash}`;  //CID content identifier
            setFileUrl(ImageURL);
        }catch(e){
            console.log(e);
        }
    ...
    // First upload metadata to IPFS anf then return URL to use in later transaction
    ...
    async function listNFTForSale(){
        ...
        if(getnetwork.chainId != rinkebyChainId){
        alert("You are not connected to Rinkeby Network");
        return;
        }
